...
class _MrtdHomePageState extends State<MrtdHomePage>
  ...
  Future<ui.Image?> hexStringToImage() async {
    // Chuyển đổi chuỗi hex thành Uint8List
    if(_mrtdData?.dg2 == null) return null;
    // Giải mã Uint8List thành ui.Image
    try{
      final ui.Codec codec = await ui.instantiateImageCodec(_mrtdData!.dg2!.toBytes());
  ...
  Widget _buildForm(BuildContext context) {
    return Column(children: <Widget>[
      if(_mrtdData != null)
      Image.memory(_mrtdData!.dg2!.imageData!),
      Card(
